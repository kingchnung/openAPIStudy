...
const GyeongnamTourcultureItem = ({ data_title, category_name1, category_name2, data_content, telno, user_address, lattitude, logitude, fileurl1, fileurl2, fileurl3 }) => {
    ...
    return (
     ...
     document.getElementById(subjectAllListBtn).addEventListener("click", ()=>{
